...
def add_args(parser):
    ...
    parser.add_argument("--model_type", default="codet5", type=str, choices=['roberta', 't5', 'bart', 'codet5', 'unixcoder'])
    ...
    parser.add_argument("--do_test_bleu", action='store_true')
